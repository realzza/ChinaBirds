...
def extract_feat(h5_path, cmn=True):
    kwargs = {
        "winlen": 0.025,
        "winstep": 0.01,
        "nfilt": 80,
...
def infer_wav(h5, detector, featExtractor, int2label_dict):
#     wav_len = sox.file_info.duration(wav)
    wav_feats = extract_feat(h5)
